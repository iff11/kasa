...
User.create!([
  {email: "demo@beauty-pay.cz", password: "demo@beauty-pay.cz", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 1664, current_sign_in_at: "2017-02-07 13:03:10", last_sign_in_at: "2017-02-07 13:03:10", current_sign_in_ip: "90.178.88.2", last_sign_in_ip: "90.178.88.2", authentication_token: "RTpasHK6B2W29VU5C6RY", deleted_at: nil, company: companies[0], role: 1}
])
items = Item.create!([
  {name: "Šamponová lázeň na barvené vlasy", selling_price: 900.0, unlimited: false, barcode: "9876543", deleted_at: nil, bought: 10, sold: 0, warning_threshold: 1, last_supply_id: 4562, is_active: true, is_service: false, company: companies[0], entity_id: 4},
  {name: "Dámský střih - krátké vlasy", selling_price: 150.0, unlimited: true, barcode: "3", deleted_at: nil, bought: 0, sold: 1, warning_threshold: 0, last_supply_id: nil, is_active: true, is_service: true, company: companies[0], entity_id: 4},
  {name: "Pánský střih", selling_price: 200.0, unlimited: true, barcode: "1", deleted_at: nil, bought: 0, sold: 4, warning_threshold: 0, last_supply_id: nil, is_active: true, is_service: true, company: companies[0], entity_id: 4},
  {name: "Střih vousů", selling_price: 100.0, unlimited: true, barcode: "12", deleted_at: nil, bought: 0, sold: 7, warning_threshold: 0, last_supply_id: nil, is_active: true, is_service: true, company: companies[0], entity_id: 4},
  {name: "Dámský střih - dlouhé vlasy", selling_price: 300.0, unlimited: true, barcode: "2", deleted_at: nil, bought: 0, sold: 4, warning_threshold: 0, last_supply_id: nil, is_active: true, is_service: true, company: companies[0], entity_id: 4},
  {name: "Nasazení pásku", selling_price: 10.0, unlimited: true, barcode: "33", deleted_at: nil, bought: 0, sold: 30, warning_threshold: 0, last_supply_id: nil, is_active: true, is_service: true, company: companies[0], entity_id: 4},
  {name: "Šampon na barvené vlasy", selling_price: 600.0, unlimited: false, barcode: "4567890", deleted_at: nil, bought: 40, sold: 6, warning_threshold: 5, last_supply_id: 4561, is_active: true, is_service: false, company: companies[0], entity_id: 4},
  {name: "Inoa 7,31", selling_price: 10.0, unlimited: false, barcode: "23456789", deleted_at: nil, bought: 120, sold: 21, warning_threshold: 60, last_supply_id: 4563, is_active: true, is_service: false, company: companies[0], entity_id: 4}
])
customers = Customer.create!([
  {first_name: "Karel", last_name: "Funda", note: nil, birth: "1972-01-01", phone: nil, mail: nil, deleted_at: nil, visits_count: 8, last_visit_date: "2017-02-27 13:03:30", gender: nil, company: companies[0], is_approved: true},
  {first_name: "Klára", last_name: "Nováková", note: nil, birth: "1987-02-01", phone: nil, mail: nil, deleted_at: nil, visits_count: 8, last_visit_date: "2017-02-27 13:03:30", gender: 1, company: companies[0], is_approved: true},
  {first_name: "Jan", last_name: "Novák", note: "Má rád presso bez cukru bez mléka", birth: "1985-07-05", phone: "723501243", mail: "novakhonza1@gmail.com", deleted_at: nil, visits_count: 18, last_visit_date: "2017-02-27 13:03:30", gender: 0, company: companies[0], is_approved: true}
])
employees = Employee.create!([
  {first_name: "Karolína", last_name: "Hezká", photo_url: "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQ0mk0OimYgpp7qDUrd2FA8FUamMBQoWAu7kXwYhevd63bqectjZA", deleted_at: nil, is_active: true, company: companies[0]},
  {first_name: "Prokop", last_name: "Buben", photo_url: "data:image/jpeg;base64,", deleted_at: nil, is_active: true, company: companies[0]}
])
visits = Visit.create!([
  {note: "Dneska byla změna - vzadu a strany strojkem", customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "250.0", received_cash: "250.0", price: "200.0", employee_share_sale: "0.0", employee_share_service: "20.0", paid_by_card: "0.0", paid_in_cash: "250.0"},
  {note: nil, customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "750.0", received_cash: "750.0", price: "750.0", employee_share_sale: "60.0", employee_share_service: "15.0", paid_by_card: "0.0", paid_in_cash: "750.0"},
  {note: nil, customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "100.0", received_cash: "0.0", price: "100.0", employee_share_sale: "0.0", employee_share_service: "10.0", paid_by_card: "100.0", paid_in_cash: "0.0"},
  {note: nil, customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "350.0", received_cash: "400.0", price: "300.0", employee_share_sale: "0.0", employee_share_service: "30.0", paid_by_card: "0.0", paid_in_cash: "350.0"},
  {note: nil, customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "200.0", received_cash: "200.0", price: "200.0", employee_share_sale: "10.0", employee_share_service: "10.0", paid_by_card: "0.0", paid_in_cash: "200.0"},
  {note: nil, customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "900.0", received_cash: "900.0", price: "900.0", employee_share_sale: "70.0", employee_share_service: "20.0", paid_by_card: "0.0", paid_in_cash: "900.0"},
  {note: nil, customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "100.0", received_cash: "0.0", price: "0.0", employee_share_sale: "0.0", employee_share_service: "0.0", paid_by_card: "100.0", paid_in_cash: "0.0"},
  {note: nil, customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "100.0", received_cash: "0.0", price: "100.0", employee_share_sale: "0.0", employee_share_service: "10.0", paid_by_card: "2000.0", paid_in_cash: "-1900.0"},
  {note: "", customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "1000.0", received_cash: "1000.0", price: "900.0", employee_share_sale: "60.0", employee_share_service: "30.0", paid_by_card: "0.0", paid_in_cash: "1000.0"},
  {note: nil, customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "300.0", received_cash: "0.0", price: "300.0", employee_share_sale: "0.0", employee_share_service: "30.0", paid_by_card: "300.0", paid_in_cash: "0.0"},
  {note: nil, customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "100.0", received_cash: "0.0", price: "100.0", employee_share_sale: "0.0", employee_share_service: "10.0", paid_by_card: "200.0", paid_in_cash: "-100.0"},
  {note: nil, customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "200.0", received_cash: "0.0", price: "200.0", employee_share_sale: "0.0", employee_share_service: "20.0", paid_by_card: "200.0", paid_in_cash: "0.0"},
  {note: nil, customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "500.0", received_cash: "0.0", price: "500.0", employee_share_sale: "0.0", employee_share_service: "50.0", paid_by_card: "500.0", paid_in_cash: "0.0"},
  {note: nil, customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "0.0", received_cash: "0.0", price: "0.0", employee_share_sale: "0.0", employee_share_service: "0.0", paid_by_card: "0.0", paid_in_cash: "0.0"},
  {note: nil, customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "1200.0", received_cash: "0.0", price: "1200.0", employee_share_sale: "120.0", employee_share_service: "0.0", paid_by_card: "1200.0", paid_in_cash: "0.0"},
  {note: nil, customer: customers[0], employee: employees[0], completed: true, deleted_at: nil, price_with_tip: "10.0", received_cash: "0.0", price: "10.0", employee_share_sale: "1.0", employee_share_service: "0.0", paid_by_card: "10.0", paid_in_cash: "0.0"},
  {note: nil, customer: customers[0], employee: employees[0], completed: false, deleted_at: nil, price_with_tip: "0.0", received_cash: "0.0", price: "1200.0", employee_share_sale: "60.0", employee_share_service: "60.0", paid_by_card: "0.0", paid_in_cash: "0.0"}
])
Sell.create!([
  {item: items[0], visit: visits[0], count: 1, price: 150.0, deleted_at: nil, entity_id: 4},
  {item: items[2], visit: visits[0], count: 1, price: 200.0, deleted_at: nil, entity_id: 4},
  {item: items[3], visit: visits[0], count: 1, price: 200.0, deleted_at: nil, entity_id: 4},
  {item: items[4], visit: visits[0], count: 1, price: 200.0, deleted_at: nil, entity_id: 4},
  {item: items[5], visit: visits[0], count: 1, price: 200.0, deleted_at: nil, entity_id: 4},
  {item: items[0], visit: visits[0], count: 2, price: 100.0, deleted_at: nil, entity_id: 4},
  {item: items[2], visit: visits[0], count: 1, price: 100.0, deleted_at: nil, entity_id: 4},
  {item: items[3], visit: visits[0], count: 1, price: 100.0, deleted_at: nil, entity_id: 4},
  {item: items[4], visit: visits[0], count: 1, price: 100.0, deleted_at: nil, entity_id: 4},
  {item: items[5], visit: visits[0], count: 1, price: 100.0, deleted_at: nil, entity_id: 4},
  {item: items[0], visit: visits[0], count: 1, price: 100.0, deleted_at: nil, entity_id: 4},
  {item: items[2], visit: visits[0], count: 1, price: 300.0, deleted_at: nil, entity_id: 4},
  {item: items[3], visit: visits[0], count: 1, price: 300.0, deleted_at: nil, entity_id: 4},
  {item: items[4], visit: visits[0], count: 1, price: 300.0, deleted_at: nil, entity_id: 4},
  {item: items[5], visit: visits[0], count: 1, price: 300.0, deleted_at: nil, entity_id: 4},
  {item: items[0], visit: visits[0], count: 30, price: 10.0, deleted_at: nil, entity_id: 4},
  {item: items[2], visit: visits[0], count: 1, price: 600.0, deleted_at: nil, entity_id: 4},
  {item: items[3], visit: visits[0], count: 2, price: 600.0, deleted_at: nil, entity_id: 4},
  {item: items[4], visit: visits[0], count: 1, price: 600.0, deleted_at: nil, entity_id: 4},
  {item: items[5], visit: visits[0], count: 1, price: 600.0, deleted_at: nil, entity_id: 4},
  {item: items[2], visit: visits[0], count: 1, price: 600.0, deleted_at: nil, entity_id: 4},
  {item: items[3], visit: visits[0], count: 1, price: 10.0, deleted_at: nil, entity_id: 4},
  {item: items[4], visit: visits[0], count: 10, price: 10.0, deleted_at: nil, entity_id: 4},
  {item: items[5], visit: visits[0], count: 10, price: 10.0, deleted_at: nil, entity_id: 4}
])
Supply.create!([
