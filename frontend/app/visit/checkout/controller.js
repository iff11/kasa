...
export default Ember.Controller.extend({
  ...
  returnAmount: Ember.computed('attrs.visit.price_with_tip', 'attrs.visit.paidInCash', function() {
    return this.get('attrs.visit.paidInCash') - this.get('attrs.visit.price_with_tip');
  }),
